...
public final class RxCommonList {

    public static final int SUBJECT_ON_CLICK_ITEM = 0;

    @Retention(SOURCE)
    @IntDef({SUBJECT_ON_CLICK_ITEM})
    @interface Subject {
    }

    private static RxBus bus = new RxBus();

    private RxCommonList() {}

    /**
     * Subscribe to the specified subject and listen for updates on that subject. Pass in an object to associate
     * your registration with, so that you can unsubscribe later.
     * <br/><br/>
     * <b>Note:</b> Make sure to call {@link RxCommonList#unregister(Object)} to avoid memory leaks.
     */
